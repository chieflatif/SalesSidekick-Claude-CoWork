...
## Step 1: Run /setup (required, one-time)
...
## Step 2: Try These 5 Commands

Once `/setup` is complete, try these in order:
...
- `/outreach [Company]` — Write a prospecting email backed by intelligence
- `/draft-post` — Create a LinkedIn post using the 3-Type Framework
- `/deck [Company]` — Generate a presentation (auto-selects template by deal stage)
- `/weekly` — Prepare your weekly pipeline summary for your manager 1:1
- `/research [Company]` — Deep company research before reaching out

---

## Need Help?

- Run `/audit` to check your configuration integrity
